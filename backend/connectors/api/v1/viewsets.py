...
class Testconnectors137081ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137081_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137081_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137081"
